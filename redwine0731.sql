...
insert  into `admin_users`(`id`,`create_time`,`username`,`password`,`salt`,`authority`,`logins`,`last_login_ip`,`last_login_time`) values (1,'2017-07-12 15:28:26','admin','8d7129b9d8615a6fcc84c144ee9a93ee','$1$Z2..u95.$IPItn5mwkpQD3I7DNUim.1',100,39,'::1','2017-07-31 10:47:47');
...
CREATE TABLE `site_forum_chat` (
  ...
  `username` char(20) NOT NULL,
  `comment` text,
  `theme_color` int(11) DEFAULT NULL,
  `display` int(11) NOT NULL,
  `display_by` char(20) NOT NULL,
  `like_num` int(11) NOT NULL,
  `dislike_num` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `site_forum_chat` */

insert  into `site_forum_chat`(`id`,`create_time`,`title`,`content`,`username`,`comment`,`theme_color`,`display`,`display_by`,`like_num`,`dislike_num`) values (1,1501492248,'撒发生地方','啊发顺丰撒旦法撒旦法是','chaoniubi',NULL,3,1,'',0,0);

/*Table structure for table `site_forum_matching` */

DROP TABLE IF EXISTS `site_forum_matching`;

CREATE TABLE `site_forum_matching` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `food_origin` int(11) DEFAULT NULL COMMENT '菜式国家',
  ...
  `detail_content` varchar(800) DEFAULT NULL COMMENT '详细内容',
...
/*Data for the table `site_forum_matching` */

insert  into `site_forum_matching`(`id`,`create_time`,`wine_name`,`wine_year`,`wine_category`,`wine_price`,`food_origin`,`food_type`,`food_name`,`food_method`,`food_taste`,`matching`,`theme_color`,`short_comment`,`detail_content`,`wine_img`,`food_img`,`username`,`display`,`display_by`,`comment`,`like_num`,`dislike_num`) values (4,1501409655,'胜多负少大红酒',1987,3,4,11,112,1122,11221,112211,0,4,'类似的份上看到了束带结发',NULL,'imgUpload/1501409638557.jpg','imgUpload/1501409641958.jpg','wolaice',0,'',NULL,0,0),(5,1501409780,'胜多负少大红酒',1988,1,5,11,112,1121,11211,112111,0,4,'dfgdfgfgdfgg',NULL,'imgUpload/1501409762728.jpg','imgUpload/1501409764866.jpg','wolaice',0,'',NULL,0,0),(6,1501480652,'不知道什么红酒',1985,3,6,11,112,1122,11221,112211,0,3,'拉丝机法律手段看风景&lt;br /&gt;\r\n拉卡了扫地机法兰克福&lt;br /&gt;\r\n&lt;br /&gt;\r\n啊是发生地方',NULL,'imgUpload/1501480555590.jpg','imgUpload/1501480617124.jpg','chaoniubi',1,'',NULL,0,0),(7,1501480918,'红红红酒',1986,0,4,21,211,0,0,0,0,0,'阿斯顿发送到发顺丰&lt;br /&gt;\r\n撒旦法撒旦法&lt;br /&gt;\r\n&lt;br /&gt;\r\nasdfasdf sd',NULL,'imgUpload/1501480850629.jpg','imgUpload/1501480895625.jpg','chaoniubi',1,'',NULL,0,0),(8,1501481284,'鬼老酒',1987,3,2,21,211,0,0,0,0,2,'拉斯科低级房了快睡觉发生发生带上副理','暗室逢灯垃圾啊水电费快来撒地方&lt;br /&gt;\r\n&lt;br /&gt;\r\n啊水电费撒旦法撒旦法的是发生地方&lt;br /&gt;\r\n啊大是大非是2312 1231231&lt;br /&gt;\r\n&lt;br /&gt;\r\n啊发的发撒旦法撒旦法','imgUpload/1501481247970.png','imgUpload/1501481252516.png','chaoniubi',1,'',NULL,0,0),(9,1501481491,'家伙粉红色',2013,5,3,11,112,1122,11221,112211,0,1,'哦加上两地分居阿龙是发顺丰','李文静人&lt;br /&gt;\r\nwesdf 是&lt;br /&gt;\r\n是的&lt;br /&gt;\r\nad &lt;br /&gt;\r\n a的&lt;br /&gt;\r\n啊&lt;br /&gt;\r\n &lt;br /&gt;\r\n啊啊 啊啊 ','imgUpload/1501481442485.jpg','imgUpload/1501481445854.jpg','chaoniubi',1,'',NULL,0,0),(10,1501486186,'爱消除v卫生法',2016,4,3,11,112,1122,11221,112211,0,4,'阿斯顿发撒发是多少发顺丰萨芬撒','碍事梨打飞机撒丽枫酒店&lt;br /&gt;\r\nasf阿斯顿发水电费sadf 阿斯顿发&lt;br /&gt;\r\n&lt;br /&gt;\r\n爱上的沙发爱上的爱上的','imgUpload/1501486142982.png','imgUpload/1501486153728.jpg','chaoniubi',1,'',NULL,0,0),(11,1501486355,'胜多负少大红酒',1980,3,3,11,112,1121,11211,112111,0,2,' 啊是的发送发的防晒伞','阿斯顿发撒打算的飞洒的\r\nasdfadsfasdfsf\r\n\r\n\r\n啊沙发沙发斯蒂芬第三方','imgUpload/1501486321326.jpg','imgUpload/1501486327278.jpg','chaoniubi',1,'',NULL,0,0),(12,1501486917,'as方法飞',1987,3,3,11,112,1122,11221,112211,3,3,'发大是大非','阿斯顿发斯蒂芬是暗示法三的\r\n\r\nasdfasdfdsf ','imgUpload/1501486881516.jpg','imgUpload/1501486889791.jpg','chaoniubi',1,'',',23',5,4),(13,1501492200,'胜多负少大红酒',1987,3,5,11,112,1121,0,0,4,3,'是打法打发','啊发顺丰','imgUpload/1501492106130.jpg','imgUpload/1501492109616.jpg','chaoniubi',1,'',NULL,0,0);
