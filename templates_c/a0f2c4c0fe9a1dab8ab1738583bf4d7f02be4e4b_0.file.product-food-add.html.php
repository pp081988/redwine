<?php
/* Smarty version 3.1.30, created on 2017-08-01 15:01:02
  from "D:\xampp\htdocs\redwine\tpl\back\product-food-add.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5980272e248b77_90543874',
...
function content_5980272e248b77_90543874 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="type" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">煮法：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="method" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">味道：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="taste" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
