<?php
/* Smarty version 3.1.30, created on 2017-08-01 14:06:04
  from "D:\xampp\htdocs\redwine\tpl\search4.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59801a4cd4aa33_32000766',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8294919101f50f6a2bcd3e9d7006b4d6ab704486' => 
    array (
      0 => 'D:\\xampp\\htdocs\\redwine\\tpl\\search4.html',
      1 => 1496654266,
      2 => 'file',
    ),
  ),
...
function content_59801a4cd4aa33_32000766 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  =========================================================-->  <section id="content"> 
      ...
      <div class="container">
        <div class="row ">         
            ...
            <div class="box2-wrapper1">
              <div class="box2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                ...
                <div class="grid_3 wbg mb10">  <div class="spic beer1">
                      <img src="images/beer.jpg">
                      <i class="b1arr"><img src="images/arrr2.png"></i>
                    </div>
                    <div class="clear"></div>
                     <div class="beer2 bbg2">
                     <li>
                     <em class="bfn1">波爾多紅酒</em><em class="bfn2"> 配</em><em class="bfn3">Ibérico 火腿</em>
                     </li>
                     <p><a class="bt5" href="#">50</a><a class="btno" href="#">50</a> </p>
                ...
                <div class="grid_3 wbg mb10">  <div class="spic beer1">
                      <img src="images/beer.jpg">
                      <i class="b1arr"><img src="images/arrr3.png"></i>
                    </div>
                    <div class="clear"></div>
                     <div class="beer2 bbg3">
                     <li>
                     <em class="bfn1">波爾多紅酒</em><em class="bfn2"> 配</em><em class="bfn3">Ibérico 火腿</em>
                     </li>
                     <p><a class="bt5" href="#">50</a><a class="btno" href="#">50</a> </p>
                 ...
                 <div class="grid_3 wbg mb10">  <div class="spic beer1">
                      <img src="images/beer.jpg">
                      <i class="b1arr"><img src="images/arrr4.png"></i>
                    </div>
                    <div class="clear"></div>
                     <div class="beer2 bbg4">
                     <li>
                     <em class="bfn1">波爾多紅酒</em><em class="bfn2"> 配</em><em class="bfn3">Ibérico 火腿</em>
                     </li>
                     <p><a class="bt5" href="#">50</a><a class="btno" href="#">50</a> </p>
        ...
        <div class="row">         
            ...
            <div class="box2-wrapper1">
              <div class="box2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                <div class="row mg0"> <div class="grid_3 wbg mb10">  <div class="spic beer1">
                      <img src="images/beer.jpg">
                      <i class="b1arr"><img src="images/arrr1.png"></i>
                    </div>
                    <div class="clear"></div>
                 ...
                 </div> <div class="grid_3 wbg mb10">  <div class="spic beer1">
                      <img src="images/beer.jpg">
                      <i class="b1arr"><img src="images/arrr2.png"></i>
                    </div>
                    <div class="clear"></div>
