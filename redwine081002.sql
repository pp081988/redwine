...
insert  into `admin_users`(`id`,`create_time`,`username`,`password`,`salt`,`authority`,`logins`,`last_login_ip`,`last_login_time`) values (1,'2017-07-12 15:28:26','admin','8d7129b9d8615a6fcc84c144ee9a93ee','$1$Z2..u95.$IPItn5mwkpQD3I7DNUim.1',100,56,'::1','2017-08-10 12:33:14');
...
insert  into `site_activate`(`id`,`username`,`activate_key`,`is_vaild`) values (7,'wolaice','HJIXJH',1),(8,'chaolihai','d8d900c89dbec00b71a04958d150778d',1),(9,'superman','YLZJGE',1),(11,'asdfsdf','4WJRTZ',1),(14,'lakfml8798','ced673236d4377852eea743aa1c5efe2',0),(15,'lajk123l','d0ba25d3884e50c2748ca8463aea6b1b',0),(16,'iweur98','WCU9XP',1),(17,'al2398098','IWU7ST',1);
