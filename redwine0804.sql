...
insert  into `admin_product_category`(`id`,`pId`,`name`,`open`,`remark`) values (1,0,'產品分類','true',NULL),(11,1,'酒類','true',NULL),(21,1,'食物','true',NULL),(111,11,'紅酒',NULL,''),(112,11,'白酒',NULL,''),(113,11,'甜酒',NULL,''),(114,11,'啤酒',NULL,''),(115,11,'威士忌',NULL,''),(116,11,'白蘭地',NULL,''),(117,11,'清酒',NULL,''),(211,21,'牛','true',''),(212,21,'羊','true',''),(213,21,'豬','true',''),(214,21,'家禽','true',''),(215,21,'海鮮','true',''),(216,21,'小食','true',''),(217,21,'甜品','true',''),(218,21,'頭盤','true',''),(219,21,'街頭食品','true',''),(220,21,'各國菜式','true',''),(2111,211,'Tongue','true','牛舌'),(2112,211,'Cheek','true','牛臉'),(2113,211,'Neck','true','頸部'),(2114,211,'Chuck','true','颈部到肩部'),(2115,211,'Brisket','true','胸肉'),(2116,211,'Foreshank','true','牛前腿上部'),(2117,211,'Backribs','true','背部排骨'),(2118,211,'Shortribs','true','牛小排'),(2119,211,'Shellsteak','true','带骨腰脊牛排'),(2120,211,'Flank','true','側邊肉'),(2112121,211,'Tenderloin','true','里脊肉'),(2112122,211,'Sirloin','true','里脊肉'),(2112123,211,'TRI-TIP','true','三角肉'),(2112124,211,'Rump','true','牛臀肉'),(2112125,211,'Hindshank','true','后腱子肉');
...
insert  into `admin_product_matching`(`id`,`create_time`,`wine_name`,`food_name`,`wine_id`,`food_id`,`suggest_type`,`suggest_name`,`matching`,`content`,`creator`) values (1,NULL,NULL,',菲力炒饭,菲力牛排','',',4,3',0,'啊水电费撒旦法撒旦法',5,'<p>as的飞洒的方式的</p><p>asdfasdfsadfsdf</p><p><br></p><p><br></p><p><br></p><p>as打法撒旦法撒旦法！</p>',NULL),(2,'2017-08-04 09:38:34',NULL,',菲力炒饭,菲力牛排,孜然牛腿排','',',4,3,2',1,'蓝色的凤姐克里斯快递费将订金',5,'<p>卡手机丢了卡萨就废了世纪东方立刻接村民V领开双刀</p><p><br></p><p><br></p><p>爱上的发的发第三方</p>',NULL),(3,'2017-08-04 10:49:07','老干妈白酒,胜多负少大红酒','孜然牛腿排',',7,6','2',1,'peter.pang',5,'<p>来自德国总部的推荐，绝对值得信任。</p>',NULL);
...
insert  into `admin_users`(`id`,`create_time`,`username`,`password`,`salt`,`authority`,`logins`,`last_login_ip`,`last_login_time`) values (1,'2017-07-12 15:28:26','admin','8d7129b9d8615a6fcc84c144ee9a93ee','$1$Z2..u95.$IPItn5mwkpQD3I7DNUim.1',100,45,'::1','2017-08-04 10:58:39');
