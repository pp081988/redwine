...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": 升序排列",sSortDescending:":降序排列"},oPaginate:{sFirst:"第一頁",sLast:"最後一頁",sNext:"下一頁",sPrevious:"上一頁"},sEmptyTable:"沒有數據",sInfo:"顯示 _START_ 到 _END_ ，共 _TOTAL_ 條",sInfoEmpty:"沒有數據",sInfoFiltered:"(從 _MAX_ 條中過濾)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"顯示 _MENU_ 條",sLoadingRecords:"加載中...",sProcessing:"處理中...",sSearch:"從當前數據中檢索:",sUrl:"",sZeroRecords:"没有找到匹配的记录"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
