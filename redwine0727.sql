...
insert  into `admin_product_category`(`id`,`pId`,`name`,`open`,`remark`) values (1,0,'產品分類','true',NULL),(11,1,'酒類','true',NULL),(111,11,'紅酒',NULL,''),(112,11,'白酒',NULL,''),(113,11,'甜酒',NULL,''),(114,11,'啤酒',NULL,''),(115,11,'威士忌',NULL,''),(116,11,'白蘭地',NULL,''),(117,11,'清酒',NULL,'');
...
insert  into `admin_users`(`id`,`create_time`,`username`,`password`,`salt`,`authority`,`logins`,`last_login_ip`,`last_login_time`) values (1,'2017-07-12 15:28:26','admin','8d7129b9d8615a6fcc84c144ee9a93ee','$1$Z2..u95.$IPItn5mwkpQD3I7DNUim.1',100,32,'::1','2017-07-27 11:14:36');
