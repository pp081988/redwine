...
insert  into `admin_users`(`id`,`create_time`,`username`,`password`,`salt`,`authority`,`logins`,`last_login_ip`,`last_login_time`) values (1,'2017-07-12 15:28:26','admin','8d7129b9d8615a6fcc84c144ee9a93ee','$1$Z2..u95.$IPItn5mwkpQD3I7DNUim.1',100,38,'::1','2017-07-30 12:28:58');
...
CREATE TABLE `site_forum_matching` (
  ...
  `short_comment` char(255) DEFAULT NULL COMMENT '短评',
...
insert  into `site_forum_matching`(`id`,`create_time`,`wine_name`,`wine_year`,`wine_category`,`wine_price`,`food_origin`,`food_type`,`food_name`,`food_method`,`food_taste`,`matching`,`theme_color`,`short_comment`,`wine_img`,`food_img`,`username`,`display`,`display_by`,`comment`,`like_num`,`dislike_num`) values (4,1501409655,'胜多负少大红酒',1987,3,4,11,112,1122,11221,112211,0,4,'类似的份上看到了束带结发','imgUpload/1501409638557.jpg','imgUpload/1501409641958.jpg','wolaice',0,'',NULL,0,0),(5,1501409780,'胜多负少大红酒',1988,1,5,11,112,1121,11211,112111,0,4,'dfgdfgfgdfgg','imgUpload/1501409762728.jpg','imgUpload/1501409764866.jpg','wolaice',0,'',NULL,0,0);
