...
insert  into `admin_product_food`(`id`,`name`,`origin`,`type`,`method`,`taste`,`keyword`,`images`,`category_id`,`category_pId`) values (5,'牛舌炒番薯','中國','不知道','炒制','鹹的','牛舌,番薯',',1501926919422.jpg',2111,211),(6,'sadfsdaf','sadfasd','fsdfasdf','asdfsad','sdfasdf','asdfasdf','',2111,211),(7,'asdfasdfsadf','sadfasdf','safdasdf','asdfasdf','asdf','Fqrd','',2111,211),(8,'asfsadfasdfQWE','AEFS','SADF','asdfasdfASDFSA','DFASDFASDF','SDFASDF','',2111,211),(9,'asdfasdfas','fdsadfasdf','dfsdf','fsdf','dfs','dfsadfasdf','',2111,211);
...
insert  into `admin_users`(`id`,`create_time`,`username`,`password`,`salt`,`authority`,`logins`,`last_login_ip`,`last_login_time`) values (1,'2017-07-12 15:28:26','admin','8d7129b9d8615a6fcc84c144ee9a93ee','$1$Z2..u95.$IPItn5mwkpQD3I7DNUim.1',100,47,'::1','2017-08-06 08:28:17');
